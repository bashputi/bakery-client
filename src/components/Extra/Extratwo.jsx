...
const Extratwo = () => {
    return (
     ...
     data-aos-duration="3000" className="w-[400px]">
                <p className="text-3xl font-bold text-[#2e7d32]">Big Momment Lil Pastry</p>
                ...
                <img className="w-96 shadow-lg" src="https://i.ibb.co/mDyV9JB/2023-11-05-2.png" alt="a pic of a cake" />
            </div>
            <div  data-aos="flip-right"
     data-aos-easing="ease-out-cubic"
     data-aos-duration="3000" className="mt-4 w-[400px]">
