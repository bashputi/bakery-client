    ...
    <p className="mb-12 md:mb-20 text-center text-gray-600 ">Product Details</p>
          <div className="card h-[60vh] grid md:grid-cols-2 card-side bg-base-900">
            ...
            <div data-aos="zoom-in" data-aos-easing="ease-out-cubic" data-aos-duration="2000" className="card-body md:-mt-8">
               ...
               <div>
                <h1 className="text-xl font-semibold text-purple-600">Share on Social Media</h1>
              
                <FacebookShareButton url={shareUrl} quote="Check out this testy desert!" hashtag="#Dessert">
                <FaFacebookSquare  className="w-10 mt-2 h-10"/>
            </FacebookShareButton>
              
            <TwitterShareButton url={shareUrl} quote="Check out this testy desert!" hashtag="#Dessert">
